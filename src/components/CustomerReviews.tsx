...
const reviews = [
  ...
  },
  {
    ...
    location: "Madurai",
    rating: 5,
    text: "தினசரி பயன்படுத்த பாதுகாப்பானது. My whole family loves it.",
    product: "Rose Soap",
    verified: true,
  },
  {
    ...
    location: "Trichy",
    rating: 5,
    text: "நம்பிக்கையுடன் பயன்படுத்தலாம். Pure herbal feel every time.",
    product: "Bath Powder",
    verified: true,
  },
  {
    ...
    rating: 5,
    text: "வீட்டில் எல்லோருக்கும் ஏற்றது. Simple, effective, and affordable.",
    product: "Face Pack",
    verified: true,
  },
];
